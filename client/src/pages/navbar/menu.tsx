...
const Menu = () => {
    return (
        <div className="fixed bottom-0 left-0 right-0  border-t border-gray-700 flex justify-around items-center px-4 py-2">
            <button className="flex flex-col items-center gap-1  hover:text-gray-600   relative">
